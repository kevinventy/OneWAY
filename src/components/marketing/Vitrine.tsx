...
/**
 * Vitrine ONE WAY — orientée transporteur unique :
 *  - Gérant : pilote son activité (/gerer)
 *  - Chauffeur : reçoit ses missions (/chauffeur)
 *  - Client : suit sa livraison en temps réel, SANS compte (/suivi)
 *
 * Aucun élément « place de marché » (commission, enchères, abonnements) —
 * One Way SARL transporte elle-même.
 */
...
export function Vitrine() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container-app flex h-16 items-center justify-between">
          ...
          <nav className="flex items-center gap-1.5 sm:gap-2">
            <Link href="/suivi" className="btn-ghost hidden sm:inline-flex">
              <Radio size={16} /> Suivre
            </Link>
            <Link href="/chauffeur" className="btn-ghost hidden sm:inline-flex">
              <Truck size={16} /> Chauffeur
            </Link>
            <Link href="/gerer" className="btn-primary">
              <LayoutDashboard size={16} /> Espace gérant
            </Link>
          </nav>
        </div>
      </header>
        ...
        <div className="container-app grid gap-10 py-14 sm:py-20 lg:grid-cols-2 lg:items-center">
          ...
          <div className="animate-slide-up rounded-2xl bg-white p-3 shadow-pop">
            ...
            <div className="flex items-center justify-between p-3 text-ink">
              <div>
                <p className="text-xs text-ink-muted">Suivi en direct</p>
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-[1.1fr_1fr]">
            ...
            <div className="card overflow-hidden">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-4">
                <div>
                  ...
                  <p className="font-bold text-ink">≈ {Math.round(357 * (1 - progress))} km · arrivée ~14h30</p>
                </div>
                <Link href="/suivi" className="btn-outline">
                  <Radio size={16} /> Suivre une livraison
                </Link>
              </div>
            </div>
            ...
            <div className="card p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-ink-muted">Exemple</p>
                  <p className="text-lg font-bold text-ink">Tana → Toamasina</p>
                </div>
                <span className="chip bg-amber-100 text-amber-600">
      ...
      {/* ── Pour qui : 3 utilisateurs (cliquables) ───────────────── */}
          ...
          {[
            {
              ...
              points: ['Créer & affecter les courses', 'Suivre tous mes camions', 'Revenus & rentabilité', 'Code de suivi auto pour le client'],
            },
            {
              icon: <Truck />,
              tag: 'Chauffeur',
              ...
              points: ['Mes courses du jour', 'Distance restante en direct', 'Avancer la livraison en 1 clic', 'Appeler le client'],
            },
            {
              icon: <Smartphone />,
              tag: 'Client',
              ...
              points: ['Suivi en direct sur la carte', 'Sans compte, juste un code', 'Heure d\'arrivée + km restants', 'Preuve de livraison reçue'],
            },
          ].map((r) => (
            <Link key={r.tag} href={r.href} className="card p-6 transition hover:shadow-pop">
        ...
        <div className="container-app">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              ...
              { icon: <Search />, title: '2. Ouvrez le lien', text: 'Cliquez sur le lien ou saisissez le code sur la page suivi. Aucune installation.' },
              { icon: <MapPin />, title: '3. Suivez en direct', text: 'Votre camion s\'affiche sur la carte, avec les km restants et l\'heure d\'arrivée.' },
            ].map((s) => (
      ...
      <footer className="bg-ink py-10 text-slate-300">
        <div className="container-app flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex gap-4 text-sm">
            ...
            <Link href="/gerer" className="hover:text-white">Gérant</Link>
            <Link href="/chauffeur" className="hover:text-white">Chauffeur</Link>
          </div>
        </div>
      </footer>
    </div>
