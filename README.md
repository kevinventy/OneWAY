...
| **Calculateur public** | Grille tarifaire ONE WAY (issue de l'Excel `OneWay_Devis_Transport`) — **carburant par type de transport** + **trajet aller-retour** (retour à vide paramétrable) |
